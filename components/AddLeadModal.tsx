...
import { INDIAN_STATES, MOCK_USERS } from '@/lib/data';
import { ProductOffered, LeadStatus } from '@/lib/types';
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          {/* SPOC Information */}
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">SPOC Information</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Sales SPOC <span className="text-red-500">*</span>
                </label>
                <select
                  required
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  School SPOC <span className="text-red-500">*</span>
                </label>
                <input
                  type="text"
                  required
